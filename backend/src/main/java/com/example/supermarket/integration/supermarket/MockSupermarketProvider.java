...
public class MockSupermarketProvider implements SupermarketProvider {
    ...
    public static final List<ExternalProduct> MOCK_PRODUCTS = List.of(
        ...
        // Sauces & Spreads
        new ExternalProduct("EXT-118", "SKU-118", "123456789018", "Tomato Ketchup", "Red Tang", "Sauces & Spreads", "https://images.unsplash.com/photo-1593539828886-f1696b0100d0?w=500&q=80", new BigDecimal("140.00"), new BigDecimal("120.00"), new BigDecimal("14.28"), 90, "IN_STOCK", "1 kg"),
        new ExternalProduct("EXT-119", "SKU-119", "123456789019", "Mixed Fruit Jam", "Sweet Spread", "Sauces & Spreads", "https://images.unsplash.com/photo-1591147779951-605fb31c53ce?w=500&q=80", new BigDecimal("160.00"), new BigDecimal("145.00"), new BigDecimal("9.37"), 60, "IN_STOCK", "500g"),
        ...
        // Household Cleaning
        new ExternalProduct("EXT-123", "SKU-123", "123456789023", "Liquid Detergent", "Clean Shine", "Household Cleaning", "https://images.unsplash.com/photo-1584820927498-cafe2c07a769?w=500&q=80", new BigDecimal("450.00"), new BigDecimal("390.00"), new BigDecimal("13.33"), 60, "IN_STOCK", "1 L"),
        new ExternalProduct("EXT-124", "SKU-124", "123456789024", "Dishwash Gel", "Sparkle", "Household Cleaning", "https://images.unsplash.com/photo-1584820926600-b8ec4b93db5e?w=500&q=80", new BigDecimal("190.00"), new BigDecimal("170.00"), new BigDecimal("10.52"), 90, "IN_STOCK", "750 ml")
    );
