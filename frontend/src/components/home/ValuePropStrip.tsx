export default function ValuePropStrip() {
  ...
  return (
    <div className="bg-surface border-y border-border py-8 my-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x-0 md:divide-x divide-border">
          {props.map((prop, i) => (
            <div key={i} className="flex items-center gap-4 px-4 justify-center md:justify-start">
